...
class CEMenuView: UIView, UICollectionViewDataSource {
    ...
    private var self_height: CGFloat {
        get {
    ...
    private func getMenueCollectionViewFrame() -> CGRect {
        return CGRect(x: 0, y: 0, width: SCREEN_WIDTH, height: self_height)
    }

    private func getSelectButtonFrame() -> CGRect {
        return CGRect(x: SCREEN_WIDTH - self_height, y: -2, width: self_height, height: self_height)
    }
