...
- (void)pagerController:(TYTabPagerController *)pagerController didSelectMoreButton:(UIButton *)button{
    
    if ([self.moreDelegate respondsToSelector:@selector(pagerController:didSelectMoreButton:)]){
        
        [self.moreDelegate pagerController:pagerController didSelectMoreButton:button ];
    }
}

- (void)pagerController:(TYTabPagerController *)pagerController didSelectAtIndexPath:(NSIndexPath *)indexPath{
    if ([self.moreDelegate respondsToSelector:@selector(pagerController:didSelectAtIndexPath:)]){
        [self.moreDelegate pagerController:pagerController didSelectAtIndexPath:indexPath];
    }
}
