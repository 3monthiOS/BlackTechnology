...
class ChatTabbarItem: RAMItemAnimation {
    ...
    func playMoveIconAnimation(_ icon : UIImageView, values: [AnyObject]) {
        ...
        let yPositionAnimation = createAnimation(Constant.AnimationKeys.PositionY, values:values, duration:duration / 2)
    ...
    func playLabelAnimation(_ textLabel: UILabel) {
        ...
        let yPositionAnimation = createAnimation(Constant.AnimationKeys.PositionY, values:[textLabel.center.y as AnyObject, (textLabel.center.y - 60.0) as AnyObject], duration:duration)
        ...
        let scaleAnimation = createAnimation(Constant.AnimationKeys.Scale, values:[1.0 as AnyObject ,2.0 as AnyObject], duration:duration)
        scaleAnimation.fillMode = kCAFillModeRemoved
        scaleAnimation.isRemovedOnCompletion = true
        textLabel.layer.add(scaleAnimation, forKey: nil)
        
        let opacityAnimation = createAnimation(Constant.AnimationKeys.Opacity, values:[1.0 as AnyObject ,0.0 as AnyObject], duration:duration)
    ...
    func playDeselectLabelAnimation(_ textLabel: UILabel) {
        ...
        let yPositionAnimation = createAnimation(Constant.AnimationKeys.PositionY, values:[(textLabel.center.y + 15) as AnyObject, textLabel.center.y as AnyObject], duration:duration)
        textLabel.layer.add(yPositionAnimation, forKey: nil)
        
        let opacityAnimation = createAnimation(Constant.AnimationKeys.Opacity, values:[0 as AnyObject, 1 as AnyObject], duration:duration)
        textLabel.layer.add(opacityAnimation, forKey: nil)
    }
}
